...
- **Image workbench** — conversational image generation and instruction-based editing for reference renders, scene shots and covers. Your own pictures (photos, sketches, references) can be imported too — pick files, drag them into the window, or paste — and are edited, adopted and exported like generated ones. Any image can be sent to modeling in one click.
