...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            command::cad::cad_import_reference,
            command::cad::cad_design_spec,
            command::cad::cad_generate,
            command::cad::cad_edit,
            command::cad::cad_review,
            command::cad::cad_run,
            command::cad::cad_set_param,
            command::cad::cad_list_versions,
            command::cad::cad_get_version,
            command::cad::cad_delete_version,
